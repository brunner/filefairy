...
_injuries = [
    table(clazz='border mb-3',
          ...
          body=[
              row(cells=[
                  cell(content=icon_absolute('T52', (
    ...
    table(clazz='border mb-3',
          ...
          body=[
              row(cells=[
                  cell(content=icon_absolute('T44', (
              ...
              row(cells=[
                  cell(content=icon_absolute('T60', (
              ...
              row(cells=[
                  cell(content=icon_absolute('T57', (
              ...
              row(cells=[
                  cell(content=icon_absolute('T40', (
...
_transactions = [
    table(
        ...
        body=[
            row(cells=[
                cell(content=icon_absolute('T53', (
            ...
            row(cells=[
                cell(content=icon_absolute('T30', (
