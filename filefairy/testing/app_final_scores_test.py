...
stnds = {
    31: {'w': 26, 'l': 44}, 32: {'w': 41, 'l': 30}, 33: {'w': 38, 'l': 35},
    34: {'w': 37, 'l': 33}, 35: {'w': 33, 'l': 39}, 36: {'w': 35, 'l': 37},
    37: {'w': 49, 'l': 21}, 38: {'w': 35, 'l': 36}, 39: {'w': 44, 'l': 26},
    40: {'w': 35, 'l': 36}, 41: {'w': 25, 'l': 46}, 42: {'w': 31, 'l': 40},
    43: {'w': 40, 'l': 34}, 44: {'w': 32, 'l': 39}, 45: {'w': 44, 'l': 26},
    46: {'w': 33, 'l': 39}, 47: {'w': 42, 'l': 30}, 48: {'w': 35, 'l': 37},
    49: {'w': 38, 'l': 34}, 50: {'w': 30, 'l': 42}, 51: {'w': 38, 'l': 33},
    52: {'w': 21, 'l': 51}, 53: {'w': 42, 'l': 30}, 54: {'w': 40, 'l': 29},
    55: {'w': 31, 'l': 41}, 56: {'w': 41, 'l': 29}, 57: {'w': 36, 'l': 36},
    58: {'w': 26, 'l': 46}, 59: {'w': 41, 'l': 29}, 60: {'w': 31, 'l': 41},
}
...
def test():
  ...
  for finalScore in inpt:
    slackApi.chatPostMessage('testing', finalScore)

  appTest.handleClose()
  time.sleep(1)
  t1.join()

  assertEquals(appTest.processFinalScores(), outpt)
  assertEquals(appTest.processRecords(), rcrds)
  assertEquals(appTest.processStandings(), stnds)
