...
from utils.subprocess.subprocess_util import Command  # noqa
from utils.subprocess.subprocess_util import check_output  # noqa


class SubprocessUtilTest(unittest.TestCase):
    @mock.patch('utils.subprocess.subprocess_util.threading.Thread')
    @mock.patch.object(Command, '_target')
    @mock.patch('utils.subprocess.subprocess_util.subprocess.Popen')
