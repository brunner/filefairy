...
def _team(encoding, abbreviation, hometown, nickname, repo, tag, home, away,
    ...
    return {
        ...
        'away': away,
        'colors': [home, away] + [alternate[:3] for alternate in alternates],
...
TEAMS = [
    ...
    _team('T46', 'MIL', 'Milwaukee', 'Brewers',
          ...
          (WHITE, '#1a4ba7', '#fbc72d'),
          (GREY, '#1a4ba7', '#fbc72d'),
          (SKY, '#1a4ba7', '#fbc72d', [SATURDAY, SUNDAY], 1.0, 'home|away')),
    _team('T47', 'MIN', 'Minnesota', 'Twins',
          '5b5568f5e186885d5e5175a25959f5d0',
          '278276af922a94ee6396cace99f17c3a308da730',
          (WHITE, '#d11242', '#052046'),
          (GREY, '#052046', '#d11242'),
          (CREAM, '#052046', '#d11242', WEEKDAYS, 1.0, 'home'),
          (BLUE, '#d11242', '#d0718f', ALL, .15, 'away')),
...
def jersey_colors(encoding, day, team, clash):
    ...
    for color, solid, border, days, pct, teams in alternates:
